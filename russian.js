      function processData() {
        ...
        for (let i = 0; i < message.length; i++) {
          ...
          if (char.match(/[а-яА-Я]/)) {
            ...
            let new_char;
            if (mode === 'encrypt') {
              new_char = String.fromCharCode((char.toLowerCase().charCodeAt(0) - 'а'.charCodeAt(0) + shift) % 33 + 'а'.charCodeAt(0));
            } else if (mode === 'decrypt') {
              new_char = String.fromCharCode((char.toLowerCase().charCodeAt(0) - 'а'.charCodeAt(0) - shift + 33) % 33 + 'а'.charCodeAt(0));
            }
